...
import com.rohitk.model.Category;
import com.rohitk.model.Product;
import com.rohitk.repository.CategoryRepository;
import com.rohitk.repository.ProductRepository;
...
public class ProductServiceImplementation implements ProductService {
	...
	public Page<Product> getAllProduct(String category, List<String> colors, List<String> sizes, Integer minPrice,
		...
		List<Product> products = productRepository.filterProucts(category, minPrice, maxPrice, minDiscount, sort);
